...
window._openDet = function (id) {
  ...
  // Campos editables de contacto y gestión
  ...
  // ── Sección vehículo ─────────────────────────────────────
  // Solo visible para pólizas de automóviles
...
window.confirmImport   = confirmXLS;
window.cancelImport    = cancelXLS;
